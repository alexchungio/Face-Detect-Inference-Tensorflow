...
class FaceDetector:
    def __init__(self, model_path=[os.path.join(os.path.dirname(__file__), 'model', 'detector.pb')]):
        """
        Arguments:
    ...
    def init_model(self,args):
        ...
        pb_path = args[0]
        model = self.init_pb(pb_path)

        return model

    def init_pb(self, model_path):
